...
export default function History() {
    ...
    const [result, SetResult] = useState({
        history: [
            { id: 'A-999', date: '26/04/2024', score: '9.5', cve_count: '57', cwe_count: '13', state: 'Critical' },
                        ...
                        <table className="table-fixed w-full border-collapse text-center">
                            ...
                            <tbody>
                                {result.history.map(
                                    (entry) =>
                                        <>
                                            <tr className={classNames((entry.state == 'Critical') ? "bg-red-500/40" : ((entry.state == 'Medium') ? "bg-yellow-500/45" : "bg-green-500/40"), "h-[6vh] ")}>
