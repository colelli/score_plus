...
export default function InfoBox(params) {
    return (
        <div className="flex flex-col pt-2 h-min h-max-[20vh] | lg:pt-0">
            <div className="border-b border-blue-300 font-bold text-lg text-white" title={params.boxTitle}>{(params.format)?camelCaseToString(params.boxTitle):params.boxTitle}</div>
